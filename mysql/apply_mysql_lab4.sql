...
-- Echo to screen statement message.
SELECT 'INSERT INTO street_address_lab' AS "Statement";
...
-- Echo to screen statement message.
SELECT 'INSERT INTO telephone_lab' AS "Statement";
...
-- Echo to screen statement message.
SELECT 'INSERT INTO item_lab' AS "Statement";
...
-- Echo to screen statement message.
SELECT 'INSERT INTO rental_lab' AS "Statement";
...
-- Echo to screen statement message.
SELECT 'INSERT INTO rental_item_lab' AS "Statement";
...
SELECT 'UPDATE member_lab' AS "Statement";
UPDATE member_lab
...
SELECT 'ALTER TABLE member_lab ADD CONSTRAINT FOREIGN KEY(member_type)' AS "Statement";
ALTER TABLE member ADD CONSTRAINT member_lab_fk3 FOREIGN KEY(member_type) REFERENCES common_lookup_lab(common_lookup_id);
