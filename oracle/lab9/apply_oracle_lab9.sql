...
, CONSTRAINT fk_account_list_2 FOREIGN KEY(consumed_by) REFERENCES system_user(system_user_id)
, CONSTRAINT fk_account_list_3 FOREIGN KEY(created_by) REFERENCES system_user(system_user_id)
, CONSTRAINT fk_account_list_4 FOREIGN KEY(last_updated_by) REFERENCES system_user(system_user_id));
